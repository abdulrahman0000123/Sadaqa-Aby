            ...
            <div className="glass-panel rounded-3xl p-4 md:p-10 flex flex-col items-center animate-fade-in-up w-full max-w-xs sm:max-w-sm mx-auto mt-8">
              ...
              <div className="w-full mb-8">
                <select 
                  ...
                  className="w-full bg-emerald-900/50 border border-amber-500/30 text-amber-400 font-amiri text-xl rounded-xl py-3 px-4 text-center appearance-none focus:outline-none focus:ring-2 focus:ring-amber-500 cursor-pointer"
              ...
              {/* النص الحالي الكبير */}
              <h3 className="text-2xl md:text-4xl text-white font-amiri text-center leading-relaxed mb-6 min-h-[60px] flex items-center justify-center">
                {currentTasbeeh.text}
              </h3>

              {/* دائرة العداد والضغط */}
              <div className="relative mb-8 flex flex-col items-center mt-6">
                <button 
                  onClick={handleTasbeehClick}
                  className="w-24 h-24 md:w-56 md:h-56 mx-auto rounded-full bg-gradient-to-tr from-emerald-800 to-emerald-600 border-4 border-amber-500 shadow-[0_0_30px_rgba(245,158,11,0.3)] flex flex-col items-center justify-center transform transition-transform active:scale-95 hover:brightness-110"
                >
                  <span className="text-4xl md:text-7xl font-cairo font-bold text-white mb-2">
                    {currentCount}
                  </span>
                  <span className="text-amber-200 font-cairo text-xs md:text-sm">
                ...
                <button 
                  ...
                  className="mt-4 bg-amber-500 hover:bg-amber-400 text-emerald-950 px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 shadow-md"
                  title="تصفير العداد"
                >
              ...
              <div className="w-full pt-6 border-t border-amber-500/20 text-center">
                <p className="text-gray-400 font-cairo text-sm mb-1">مجموع التسبيحات الكلي</p>
                <p className="text-2xl text-amber-500 font-bold font-cairo">{totalCount}</p>
              </div>
            </div>
          )}
